...
namespace Sidub.Platform.Storage.Http.Test.Models.TripPin
{
    ...
    public class PeopleByGenderQuery : IEnumerableQuery<Person>
    {
        ...
        public PeopleByGenderQuery(Gender gender)
        {
            Gender = gender;
        }
        ...
        public IFilter? GetFilter()
        {
            ...
            builder.Add("Gender", ComparisonOperator.Equals, Gender.ToString());
