...
namespace Sidub.Platform.Storage.Handlers.Http.Factories
{
    ...
    /// <summary>
    /// Factory class for creating BlobQueryHandler instances.
    /// </summary>
    public class BlobQueryHandlerFactory : IQueryHandlerFactory<BlobStorageConnector>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlobQueryHandlerFactory"/> class.
        /// </summary>
        ...
        public BlobQueryHandlerFactory(IServiceRegistry metadataService, ODataDataProviderService dataProviderService, IEntitySerializerService entitySerializerService)
        {
            ...
            where TQuery : IQuery<TResponse>
        {
            ...
            if (typeof(TQuery).GetGenericTypeDefinition() == typeof(IBlobQuery<>))
                return true;
            ...
            where TQuery : IQuery<TResponse>
        {
            ...
            var handlerType = typeof(BlobQueryHandler<>).MakeGenericType(new[] { entityType });
            var handlerParameters = new object[] { _metadataService, _dataProviderService, _entitySerializerService };
