...
namespace Sidub.Platform.Storage.Handlers.Http.Factories
{
    ...
    /// <summary>
    /// Factory class for creating instances of SaveBlobCommandHandler.
    /// </summary>
    public class SaveBlobCommandHandlerFactory : ICommandHandlerFactory<BlobStorageConnector>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SaveBlobCommandHandlerFactory class.
        /// </summary>
        ...
        public SaveBlobCommandHandlerFactory(IServiceRegistry metadataService, ODataDataProviderService dataProviderService, IEntitySerializerService entitySerializerService, IFilterService<ODataFilterConfiguration> filterService, IEntityPartitionService entityPartitionService)
        {
        ...
        /// <returns>True if the command and result types are handled; otherwise, false.</returns>
        ...
        /// <exception cref="Exception">Thrown if the specified command and result types are not handled.</exception>
            ...
            where TResult : ICommandResponse
        {
            ...
            var handlerType = typeof(SaveBlobCommandHandler<>).MakeGenericType(new[] { entityType });
