...
namespace Sidub.Platform.Storage
{
    ...
    /// <summary>
    /// Represents a connector for Blob storage.
    /// </summary>
    public class BlobStorageConnector : IHttpStorageConnector
    {

        #region Public properties

        /// <summary>
        /// Gets or sets the service URI for the Blob storage.
        /// </summary>
        ...
        /// <summary>
        /// Gets the request headers for the Blob storage.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlobStorageConnector"/> class.
        /// </summary>
        public BlobStorageConnector()
        {
            Initialize();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="BlobStorageConnector"/> class with the specified service URI.
        /// </summary>
        /// <param name="serviceUri">The service URI for the Blob storage.</param>
        public BlobStorageConnector(string serviceUri)
        {
            Initialize();
        ...
        /// <summary>
        /// Initializes the Blob storage connector with default values.
        /// </summary>
