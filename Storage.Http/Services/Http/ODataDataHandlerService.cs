...
namespace Sidub.Platform.Storage.Services.Http
{
    ...
    /// </summary>
    public class ODataDataHandlerService : DataHandlerServiceBase<ODataStorageConnector>
    {
        ...
        public ODataDataHandlerService(
            ...
            IEnumerable<ICommandHandlerFactory<ODataStorageConnector>> commandHandlers,
            IEnumerable<IQueryHandlerFactory<ODataStorageConnector>> queryHandlers)
        ...
        /// <summary>
        /// Determines whether the specified storage connector is handled by this service.
        /// </summary>
        /// <param name="connector">The storage connector.</param>
        /// <returns><c>true</c> if the storage connector is handled by this service; otherwise, <c>false</c>.</returns>
        public override bool IsHandled(IStorageConnector connector)
        {
            return connector is ODataStorageConnector
                || connector is TableStorageConnector;
        }
        ...
        {
            var handler = new EntitySaveCommandHandler<TEntity, ODataStorageConnector>(_metadataService, _dataProviderService, _entitySerializerService, _filterService, _entityPartitionService);
            return handler;
        }
